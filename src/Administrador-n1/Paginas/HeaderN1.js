...
{/* 
                        ...
                        <li className='nav-item1'>
                            <Link to='/citas' className='nav-links1' onClick={closeMobileMenu}  >
                                <p>Citas</p>
                            </Link>
                        </li>
                        ...
                        <li className='nav-item1 '>
                            <Link to='/urgencias' className='nav-links1' onClick={closeMobileMenu}>
                            <p>Urgencias</p>
                            </Link>
                        </li>
                        ...
                        <li className='nav-item1 '>
                            <Link to='/programas' className='nav-links1' onClick={closeMobileMenu}>
                            <p>Programas</p>
                            </Link>
                        </li>
